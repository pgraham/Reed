 ...
 */
/**
 * This class is an extension that to Oboe_Form_TextInput that allows a hidden
 ...
 * @package Reed
 */
class Reed_Form_AjaxHiddenInput extends Reed_Form_AjaxInput {

    /**
     * Constructor
     *
     * @param id - Since thid input isn't part of a form a name isn't required
    ...
    public function __construct($id = null, $value = null) {
        $input = new Oboe_Form_Password('ajaxinput');
        if ($id !== null) {
            $input->setId($id);
        }
