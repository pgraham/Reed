...
class Reed_DebugCatcher {
    ...
    public function flush() {
        ...
        if ($this->_container === null) {
            $this->_container = new Oboe_Div('debugging');
            Oboe_Body::getInstance()->add($this->_container);
        }
        $this->_container->addChild(new Oboe_Heading('Debug Information'));
        $this->_container->addChild(new Oboe_Paragraph($this->_captured));
    }
     ...
     *
     * @param Oboe_ElementBase must implement Oboe_Item_Body
     */
