 ...
 * @package Reed
 */
class Reed_Page extends Oboe_Page {
    ...
    public static function init() {
        ...
        parent::setInstance(new Reed_Page());
     ...
     * @param Reed_Template
     */
    public static function setTemplate(Reed_Template $template) {
     ...
     */
    protected function setPageTemplate(Reed_Template $template) {
        ...
        $validator = new Reed_TemplateValidator($template);
        $validator->validate();
